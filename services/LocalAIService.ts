...
export const chatCompletion = async (
  ...
  // Complex logic tasks (smart) and parsing need much more time — invoices can take up to 2-3 mins on 14B models
  const timeoutMs = isVision || model === 'smart' ? 300000 : 60000;
...
1. "DUPLICATE": Items that represent the exact same physical product (same active ingredient, dosage, or tool). CRITICAL RULE: If two items share 50% or more of the same words in their name, you MUST flag them as a DUPLICATE. Ignore casing, spelling mistakes, or synonyms (e.g., "Gasa 4x4" vs "Gasas 4x4", "Ibuprofen 200mg" vs "Advil 200mg", "Alcohol Prep Pads" vs "Alcohol Swabs"). You MUST be incredibly strict and aggressive about catching variations.
